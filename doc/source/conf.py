...
# Base name: project without whitespace;
#            version without the dot;
#            doc
# Base name example: PerconaServer57doc
...
# (source start file, target name (example: 'PerconaServer-5.7.tex'),
...
intersphinx_mapping = {
    ...
    'ps57' : ('https://www.percona.com/doc/percona-server/5.7/', None),
    'ps80' : ('https://www.percona.com/doc/percona-server/8.0/', None),
